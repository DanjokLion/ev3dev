...
class Puppy:
    ...
    DIZZY_EYES = Image(ImageFile.DIZZY)
    ANGRY_EYES = Image(ImageFile.ANGRY)
    WINKING_EYES = Image(ImageFile.WINKING)
    SQUINTY_EYES = Image(ImageFile.KNOCKED_OUT)  # the tear is erased later
